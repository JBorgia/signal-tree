 ...
 * words — "replace" is already a `mutationIntent` value, and reusing it as the
 * public contract word conflates the two layers. (It was also a `MutationKind`
 * member until 15.0 deleted that type; the collision this warns about is with
 * the intent, which is live.)
 */
