// CANDIDATE CONFORMANCE — branches on the ACTUAL result, and checks EVERY step.
//
...
const report = {
  ...
  publicationScope:
    ...
    'DISALLOWED CHANGED SNAPSHOT reached that projection, not zero native notifications',
