...
| `@signaltree/angular`         | **`@signal-tree/angular`** — Angular observation for universal locations; **Angular apps import `signalTree` from here** and use `toWritableSignal()` only at native-signal boundaries    |
| _(new)_                       | **`@signal-tree/react`** — owner-bound React observation (`useSignalTree`)                                                                                                                |
| _(new)_                       | **`@signal-tree/vue`** — Vue dependency observation for direct location reads                                                                                                             |
